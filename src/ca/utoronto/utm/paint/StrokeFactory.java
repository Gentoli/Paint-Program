...
public class StrokeFactory {
	...
	public Stroke createStroke(int strokeStyle, float lineThickness) {
		...
		if(strokeStyle == 1)
			return new BasicStroke(lineThickness, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 10.0f, new float[]{16.0f, 20.0f}, 0.0f);
		if(strokeStyle == 2)
			return new ShapeStroke(new Ellipse2D.Double(0, 0, lineThickness, lineThickness), lineThickness + 5, false);
