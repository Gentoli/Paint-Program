...
public class StrokeFactory {
    ...
    public Stroke createStroke(int strokeStyle, float lineThickness) {
        ...
        if(strokeStyle==2)return new ShapeStroke(new Ellipse2D.Double(0,0,lineThickness,lineThickness), lineThickness+5);
        if(strokeStyle==3)return new ShapeStroke(new QuadCurve2D.Double(-1.0,0.0,1.0,0.0,1.0,1.0), 2);
